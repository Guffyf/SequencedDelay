...
void BasicDelayAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    {
        fillDelayBuffer(buffer, delayBuffer, bufferSize, delayBufferSize, channel);

        readDelayBuffer(buffer, delayBuffer, bufferSize, delayBufferSize, channel);
...
void BasicDelayAudioProcessor::fillDelayBuffer(juce::AudioBuffer<float>& buffer, juce::AudioBuffer<float>& delayBuffer, int bufferSize, int delayBufferSize, int channel)
{
...
void BasicDelayAudioProcessor::readDelayBuffer(juce::AudioBuffer<float>& buffer, juce::AudioBuffer<float>& delayBuffer, int bufferSize, int delayBufferSize, int channel)
{
